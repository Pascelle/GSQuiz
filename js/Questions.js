...
$(document).ready(function(){
	...
	var question1 = {
		...
		choices: [Canine, Alsatian, Belgian Shepherd, Ankle Biter]
		correctans: "Alsatian"
		info: "During World War I and World War II German Shepherds were often used in the war effort. This extremely intelligent breed served as messenger dogs, guard dogs, and search and rescue animals. Fearing the anti-German sentiments prevalent in the U.S. and England during World War I would spread to the dogs, officials began calling them Alsatians. It was not until 1930 that the name German Shepherd was reestablished in England."
	}

	var question2 = {
		pic: "img/gspic3.jpg",
		ask: "German Shepherds are often used as ________ dogs."
		choices: [Lounging, Hunting, Working, Purse]
		correctans: "Working"
		info: "German Shepherds are working dogs. Highly trainable, loyal and obedient they have been used in various capacities.  As their name implies they have often been used in herding, but also serve as search and rescue dogs, guide dogs, and police dogs. If not trained properly though, these strong dogs can be quite aggressive. They have been subject to Breed Specific Legislation, which are laws controlling or even prohibiting certain breeds, including German Shepherds, in certain areas."
	}
	...
	var question4 = {
		...
		choices: [Franklin D\. Roosevelt, Gerald Ford, Bill Clinton, Richard Nixon]
